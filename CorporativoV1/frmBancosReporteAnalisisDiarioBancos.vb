...
Public Class frmBancosReporteAnalisisDiarioBancos
    Inherits System.Windows.Forms.Form

    Private components As System.ComponentModel.IContainer
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    '**********************************************************************************************************************'
    '*PROGRAMA :             REPORTE DE ANALISIS DIARIO DE BANCOS                                                         *'
    '*AUTOR :                JUAN CARLOS OSUNA CORRALES                                                                   *'
    '*FECHA DE INICIO :      SABADO 28 DE FEBRERO DE 2004                                                                 *'
    ...
    Sub Imprime()
        ...
        Dim rptBancosReporteAnalisisDiarioBancos As New rptBancosReporteAnalisisDiarioBancos
        ...
        If chkIncluirBancos.CheckState = System.Windows.Forms.CheckState.Checked Then
            Sql = "SELECT * FROM DBO.ObtenerSaldoXBanco('" & fechaInicial1 & "','" & fechaFinal2 & "',1,1,0) ORDER BY CodBanco,DescBanco,CtaBancaria,FechMovto"
        ElseIf chkIncluirBancos.CheckState = System.Windows.Forms.CheckState.Unchecked Then
            Sql = "SELECT * FROM DBO.ObtenerSaldoXBanco('" & fechaInicial1 & "','" & fechaFinal2 & "',0,1," & intCodBanco & ") ORDER BY CodBanco,DescBanco,CtaBancaria,FechMovto"
        End If

        NombreEmpresa = UCase(gstrCorpoNOMBREEMPRESA)
        NombreReporte = UCase("Reporte de Analisis Diario de Bancos")
        PeriodoReporte = "Del  " & fechaInicial1 & "  Hasta el  " & fechaFinal2
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptBancosReporteAnalisisDiarioBancos.SetDataSource(frmReportes.rsReport)
        End If
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
        'frmReportes.aFormula_ = New Object() {"NombreEmpresa", "NombreReporte", "Periodo", "TipoCambio"}
        'frmReportes.aValues_ = New Object() {NombreEmpresa, NombreReporte, PeriodoReporte, TipoCambio}
        ...
        frmReportes.reporteActual = rptBancosReporteAnalisisDiarioBancos
        frmReportes.Show()
...
ImprimeErr:
    ...
    Private Sub chkIncluirFoliosCancel_GotFocus()
        Pon_Tool()
    End Sub
    ...
    Private Sub frmBancosReporteAnalisisDiarioBancos_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmBancosReporteAnalisisDiarioBancos_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmBancosReporteAnalisisDiarioBancos_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmBancosReporteAnalisisDiarioBancos_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmBancosReporteAnalisisDiarioBancos_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
    ...
    Private Sub frmBancosReporteAnalisisDiarioBancos_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmBancosReporteAnalisisDiarioBancos_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    ...
    Sub InitializeComponent()
        ...
        Me.chkIncluirBancos.Size = New System.Drawing.Size(126, 18)
        ...
        Me.Frame1.Location = New System.Drawing.Point(11, 9)
        ...
        Me.dtpFechaInicial.Location = New System.Drawing.Point(71, 24)
        ...
        Me.Frame2.Location = New System.Drawing.Point(11, 79)
        ...
        Me.dbcBanco.Size = New System.Drawing.Size(281, 21)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(126, 177)
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(11, 177)
        ...
        '
        'frmBancosReporteAnalisisDiarioBancos
        '
        ...
        Me.Name = "frmBancosReporteAnalisisDiarioBancos"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Reporte de Analisis Diario de Bancos"
