...
Public Class frmVtasRPTVentasSalidadeMercancia
    ...
    Public Sub InitializeComponent()
        ...
        Me.txtMensaje.Location = New System.Drawing.Point(12, 192)
        ...
        Me.txtMensaje.Size = New System.Drawing.Size(350, 58)
        ...
        Me.chkImpuesto.Location = New System.Drawing.Point(12, 136)
        ...
        Me.chkImpuesto.Size = New System.Drawing.Size(139, 26)
        ...
        Me.chkDetallar.Location = New System.Drawing.Point(12, 117)
        ...
        Me.chkDetallar.Size = New System.Drawing.Size(148, 19)
        Me.chkDetallar.TabIndex = 9
        ...
        Me._fraVtas_1.Location = New System.Drawing.Point(6, 65)
        ...
        Me._fraVtas_1.Size = New System.Drawing.Size(356, 46)
        ...
        Me.dtpHasta.Location = New System.Drawing.Point(236, 19)
        ...
        Me._lblVentas_2.Location = New System.Drawing.Point(186, 23)
        ...
        Me._fraVtas_0.Location = New System.Drawing.Point(6, 13)
        ...
        Me._fraVtas_0.Size = New System.Drawing.Size(301, 46)
        ...
        'dbcSucursal
        '
        Me.dbcSucursal.Location = New System.Drawing.Point(72, 17)
        ...
        Me._lblRpt_2.Location = New System.Drawing.Point(10, 165)
        ...
        'btnImprimir
        '
        Me.btnImprimir.Location = New System.Drawing.Point(12, 268)
        ...
        '
        'frmVtasRPTVentasSalidadeMercancia
        '
        ...
        Me.KeyPreview = True
        Me.Location = New System.Drawing.Point(248, 91)
        Me.Margin = New System.Windows.Forms.Padding(2)
        Me.MaximizeBox = False
        Me.Name = "frmVtasRPTVentasSalidadeMercancia"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Ventas por período y por sucursal"
...
Err_Renamed:
    ...
    Public Sub Imprime()
        ...
        Dim rptVentasSalidaDeMercancia1 As New rptVentasSalidaDeMercancia
        ...
        'Dim rptVentasSalidaDeMercancia As Object = ""
        On Error GoTo Merr
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptVentasSalidaDeMercancia1.SetDataSource(frmReportes.rsReport)
        End If
        ...
        If (txtMensaje.Text <> Nothing) Then
            ...
            rptVentasSalidaDeMercancia1.DataDefinition.ParameterFields("Mensaje").ApplyCurrentValues(pvNum)
        Else
        ...
        If (dtpDesde.Value <> Nothing) Then
            ...
            rptVentasSalidaDeMercancia1.DataDefinition.ParameterFields("dDesde").ApplyCurrentValues(pvNum)
        End If
        ...
        If (dtpHasta.Value <> Nothing) Then
            ...
            rptVentasSalidaDeMercancia1.DataDefinition.ParameterFields("dHasta").ApplyCurrentValues(pvNum)
        End If
        ...
        If (gstrNombCortoEmpresa <> Nothing) Then
            ...
            rptVentasSalidaDeMercancia1.DataDefinition.ParameterFields("Empresa").ApplyCurrentValues(pvNum)
        End If
        ...
        If (chkImpuesto.CheckState <> Nothing) Then
            ...
            rptVentasSalidaDeMercancia1.DataDefinition.ParameterFields("IncluyeImpuesto").ApplyCurrentValues(pvNum)
        End If


        'If Me.chkDetallar.CheckState = System.Windows.Forms.CheckState.Unchecked Then
        '    rptVentasSalidaDeMercancia.DeleteGroup(3)
        '    rptVentasSalidaDeMercancia.DeleteGroup(2)
        'End If 

        frmReportes.reporteActual = rptVentasSalidaDeMercancia1
        frmReportes.Show()
...
Merr:
    ...
    End Sub
    Private Sub frmVtasRPTVentasSalidadeMercancia_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmVtasRPTVentasSalidadeMercancia_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmVtasRPTVentasSalidadeMercancia_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmVtasRPTVentasSalidadeMercancia_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmVtasRPTVentasSalidadeMercancia_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
    ...
    Private Sub frmVtasRPTVentasSalidadeMercancia_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmVtasRPTVentasSalidadeMercancia_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
