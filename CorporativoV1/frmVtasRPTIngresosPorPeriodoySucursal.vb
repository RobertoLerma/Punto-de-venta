...
Public Class frmVtasRPTIngresosPorPeriodoySucursal
    ...
    Public Sub InitializeComponent()
        ...
        Me.txtMensaje.Location = New System.Drawing.Point(6, 177)
        ...
        Me.txtMensaje.Size = New System.Drawing.Size(381, 65)
        ...
        Me.chkDescontar.Location = New System.Drawing.Point(9, 124)
        ...
        Me.chkDescontar.Size = New System.Drawing.Size(166, 20)
        ...
        Me.chkTodas.Size = New System.Drawing.Size(131, 20)
        ...
        Me._fraVtas_3.Location = New System.Drawing.Point(6, 59)
        ...
        Me._fraVtas_3.Size = New System.Drawing.Size(381, 53)
        ...
        Me.dtpDesde.Location = New System.Drawing.Point(73, 20)
        ...
        Me.dtpHasta.Location = New System.Drawing.Point(267, 20)
        ...
        Me._lblVentas_3.Location = New System.Drawing.Point(32, 23)
        ...
        Me._lblVentas_2.Location = New System.Drawing.Point(229, 24)
        ...
        'dbcSucursal
        '
        Me.dbcSucursal.Location = New System.Drawing.Point(79, 31)
        ...
        Me._lblVentas_0.Location = New System.Drawing.Point(27, 33)
        ...
        Me._lblRpt_2.Location = New System.Drawing.Point(9, 154)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(122, 256)
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(7, 256)
        ...
        'btnBuscar
        '
        Me.btnBuscar.Location = New System.Drawing.Point(237, 257)
        ...
        '
        'frmVtasRPTIngresosPorPeriodoySucursal
        '
        ...
        Me.Name = "frmVtasRPTIngresosPorPeriodoySucursal"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Ingresos de Ventas por Período y Sucursal"
...
Merr:
    ...
    Public Function DevuelveQuery() As String
        ...
        cSELECT = " select a.CodSucursal, a.FolioIngreso, a.FechaIngreso, a.FolioMovto, b.DescAlmacen as DescSucursal, " & " a.TipoMovto, a.nTipoMovto, " & cINGRESONETO & " as TotalDolares, " & " dbo.ConvertirCantidad('D', 'P', " & cINGRESONETO & ", a.TipoCambio, 12) as TotalPesos " & " from vwingresos a " & " inner join CatAlmacen b on b.CodAlmacen = a.CodSucursal " & " where a.TipoMovto is not null and (a.FechaIngreso between '" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "' and '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "') " & cWHERE & " order by a.CodSucursal, a.FechaIngreso, a.nTipoMovto "
...
Merr:
    ...
    Public Sub Imprime()
        ...
        Dim rptVentasIngresosPorPeriodoySucursal As New rptVentasIngresosPorPeriodoySucursal
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptVentasIngresosPorPeriodoySucursal.SetDataSource(frmReportes.rsReport)
        End If
        ...
        If (txtMensaje.Text <> Nothing) Then
            ...
            rptVentasIngresosPorPeriodoySucursal.DataDefinition.ParameterFields("Mensaje").ApplyCurrentValues(pvNum)
        Else
        ...
        If (dtpDesde.Value <> Nothing) Then
            ...
            rptVentasIngresosPorPeriodoySucursal.DataDefinition.ParameterFields("dDesde").ApplyCurrentValues(pvNum)
        End If

        If (dtpHasta.Value <> Nothing) Then
            pdvNum.Value = dtpHasta.Value : pvNum.Add(pdvNum)
            rptVentasIngresosPorPeriodoySucursal.DataDefinition.ParameterFields("dHasta").ApplyCurrentValues(pvNum)
        End If

        If (gstrNombCortoEmpresa <> Nothing) Then
            pdvNum.Value = gstrNombCortoEmpresa : pvNum.Add(pdvNum)
            rptVentasIngresosPorPeriodoySucursal.DataDefinition.ParameterFields("Empresa").ApplyCurrentValues(pvNum)
        End If
        ...
        If (Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Checked Or Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Unchecked) Then
            ...
            rptVentasIngresosPorPeriodoySucursal.DataDefinition.ParameterFields("DescontarComision").ApplyCurrentValues(pvNum)
        End If


        frmReportes.reporteActual = rptVentasIngresosPorPeriodoySucursal 'Es el nombre del archivo que se incluyó en el proyecto
        frmReportes.Show()
...
Merr:
    ...
    End Sub
    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
    ...
    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmVtasRPTIngresosPorPeriodoySucursal_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
