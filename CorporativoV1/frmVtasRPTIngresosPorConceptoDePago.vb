...
Public Class frmVtasRPTIngresosPorConceptoDePago
    ...
    Public Sub InitializeComponent()
        ...
        Me.txtMensaje.Location = New System.Drawing.Point(6, 200)
        ...
        Me.txtMensaje.Size = New System.Drawing.Size(343, 74)
        ...
        Me.chkDescontar.Checked = True
        Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Checked
        ...
        Me.chkDescontar.Location = New System.Drawing.Point(6, 149)
        ...
        Me.chkDescontar.Size = New System.Drawing.Size(168, 17)
        ...
        Me.chkTodas.Size = New System.Drawing.Size(148, 17)
        ...
        Me._fraVtas_3.Location = New System.Drawing.Point(6, 84)
        ...
        Me._fraVtas_3.Size = New System.Drawing.Size(343, 53)
        ...
        Me.dtpDesde.Location = New System.Drawing.Point(64, 16)
        ...
        Me.dtpHasta.Location = New System.Drawing.Point(233, 17)
        ...
        Me._lblVentas_3.Location = New System.Drawing.Point(19, 17)
        ...
        Me._lblVentas_2.Location = New System.Drawing.Point(186, 20)
        ...
        'dbcSucursal
        '
        Me.dbcSucursal.Location = New System.Drawing.Point(68, 44)
        ...
        Me._lblVentas_0.Location = New System.Drawing.Point(16, 46)
        ...
        Me._lblRpt_2.Location = New System.Drawing.Point(4, 176)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(118, 288)
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(3, 288)
        ...
        'btnBuscar
        '
        Me.btnBuscar.Location = New System.Drawing.Point(233, 289)
        ...
        '
        'frmVtasRPTIngresosPorConceptoDePago
        '
        ...
        Me.Name = "frmVtasRPTIngresosPorConceptoDePago"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Ingresos por Concepto de Pago"
...
Merr:
    ...
    Public Function DevuelveQuery() As String
        ...
        If mintCodSucursal <> 0 Then
            cWHERE = " where a.CodSucursal = " & mintCodSucursal
            cWHERE2 = " AND b.CodSucursal = " & mintCodSucursal
        End If

        cSELECT = " select 0 as CodSucursal, '' as DescSucursal, a.CodFormaPago, a.DescripcionFormaPago, " & " 1 as TipoRegistro, " & " case Moneda when 'D' then 0 " & " when 'P' then (select sum(b.importe) from dbo.IngresosPorConceptoDePago('" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "', '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "', " & Me.chkDescontar.CheckState & ") b where b.CodFormaPago = a.CodFormaPago and b.DescripcionFormaPago = a.DescripcionFormaPago " & cWHERE2 & ") end as ImportePesos, " & " case Moneda when 'D' then (select sum(b.importe) from dbo.IngresosPorConceptoDePago('" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "', '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "', " & Me.chkDescontar.CheckState & ") b where b.CodFormaPago = a.CodFormaPago and b.DescripcionFormaPago = a.DescripcionFormaPago " & cWHERE2 & ") " & " when 'P' then 0 end as ImporteDolares " & " from dbo.IngresosPorConceptoDePago('" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "', '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "', " & Me.chkDescontar.CheckState & ") a " & cWHERE & " Union " & " select a.CodSucursal, b.DescAlmacen as DescSucursal, a.CodFormaPago, a.DescripcionFormaPago, " & " 2 as TipoRegistro, " & " sum(case a.Moneda when 'D' then 0 " & " when 'P' then a.Importe end) as ImportePesos, " & " sum(case a.Moneda when 'D' then a.Importe " & " when 'P' then 0 end) as ImporteDolares " & " from dbo.IngresosPorConceptoDePago('" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "', '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "', " & Me.chkDescontar.CheckState & ") a " & " inner join CatAlmacen b on b.CodAlmacen = a.CodSucursal " & cWHERE & " group by a.CodSucursal,b.DescAlmacen,a.CodFormaPago,a.DescripcionFormaPago " & " order by a.CodSucursal, a.DescripcionFormaPago "
...
Merr:
    ...
    Public Sub Imprime()
        Dim rptVentasIngresosPorConceptoDePago As New rptVentasIngresosPorConceptoDePago
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptVentasIngresosPorConceptoDePago.SetDataSource(frmReportes.rsReport)
        End If
        ...
        If (txtMensaje.Text <> Nothing) Then
            ...
            rptVentasIngresosPorConceptoDePago.DataDefinition.ParameterFields("Mensaje").ApplyCurrentValues(pvNum)
        Else
        ...
        If (dtpDesde.Value <> Nothing) Then
            ...
            rptVentasIngresosPorConceptoDePago.DataDefinition.ParameterFields("dDesde").ApplyCurrentValues(pvNum)
        End If

        If (dtpHasta.Value <> Nothing) Then
            pdvNum.Value = dtpHasta.Value : pvNum.Add(pdvNum)
            rptVentasIngresosPorConceptoDePago.DataDefinition.ParameterFields("dHasta").ApplyCurrentValues(pvNum)
        End If

        If (gstrNombCortoEmpresa <> Nothing) Then
            pdvNum.Value = gstrNombCortoEmpresa : pvNum.Add(pdvNum)
            rptVentasIngresosPorConceptoDePago.DataDefinition.ParameterFields("Empresa").ApplyCurrentValues(pvNum)
        End If
        ...
        If (Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Checked Or Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Unchecked) Then
            ...
            rptVentasIngresosPorConceptoDePago.DataDefinition.ParameterFields("DescontarComision").ApplyCurrentValues(pvNum)
        End If



        frmReportes.reporteActual = rptVentasIngresosPorConceptoDePago 'Es el nombre del archivo que se incluyó en el proyecto
        frmReportes.Show()
...
Merr:
    ...
    End Sub
    Private Sub frmVtasRPTIngresosPorConceptoDePago_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmVtasRPTIngresosPorConceptoDePago_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmVtasRPTIngresosPorConceptoDePago_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmVtasRPTIngresosPorConceptoDePago_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmVtasRPTIngresosPorConceptoDePago_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
    ...
    Private Sub frmVtasRPTIngresosPorConceptoDePago_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmVtasRPTIngresosPorConceptoDePago_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
