...
Public Class frmVtasRPTIngresosPorReparaciones
    ...
    Public Sub InitializeComponent()
        ...
        Me.txtMensaje.Location = New System.Drawing.Point(6, 202)
        ...
        Me.txtMensaje.Size = New System.Drawing.Size(334, 78)
        ...
        Me.chkDescontar.Location = New System.Drawing.Point(12, 140)
        ...
        Me.chkDescontar.Size = New System.Drawing.Size(166, 17)
        ...
        Me._fraVtas_3.Location = New System.Drawing.Point(6, 65)
        ...
        Me._fraVtas_3.Size = New System.Drawing.Size(334, 53)
        ...
        Me.dtpDesde.Location = New System.Drawing.Point(59, 23)
        ...
        Me.dtpHasta.Location = New System.Drawing.Point(216, 23)
        ...
        Me._lblVentas_2.Location = New System.Drawing.Point(177, 29)
        ...
        Me._lblVentas_3.Location = New System.Drawing.Point(17, 29)
        ...
        Me.chkTodas.Size = New System.Drawing.Size(130, 22)
        ...
        'dbcSucursal
        '
        Me.dbcSucursal.Location = New System.Drawing.Point(70, 33)
        ...
        Me._lblRpt_2.Location = New System.Drawing.Point(10, 178)
        ...
        Me._lblVentas_0.Location = New System.Drawing.Point(18, 33)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(119, 302)
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(4, 302)
        ...
        'btnBuscar
        '
        Me.btnBuscar.Location = New System.Drawing.Point(234, 303)
        ...
        '
        'frmVtasRPTIngresosPorReparaciones
        '
        Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 13.0!)
        Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
        Me.BackColor = System.Drawing.SystemColors.Control
        Me.ClientSize = New System.Drawing.Size(355, 351)
        ...
        Me.Name = "frmVtasRPTIngresosPorReparaciones"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Ingresos por Reparaciones"
...
Merr:
    ...
    Public Function DevuelveQuery() As String
        ...
        cSELECT = " select a.CodSucursal, a.CodCliente, c.DescCliente, a.FolioIngreso, a.FechaIngreso, a.FolioMovto, a.FechaMovto, " & " b.DescAlmacen as DescSucursal, " & " a.TipoMovto, a.nTipoMovto, " & cINGRESONETO & " as TotalDolares, " & " dbo.ConvertirCantidad('D', 'P', " & cINGRESONETO & ", a.TipoCambio, 12) as TotalPesos " & " from vwingresos a " & " inner join CatAlmacen b on b.CodAlmacen = a.CodSucursal " & " inner join CatClientes c on c.CodCliente = a.CodCliente " & " where a.TipoMovto is not null and " & " (a.FechaIngreso between '" & VB6.Format(Me.dtpDesde.Value, C_FORMATFECHAGUARDAR) & "' and '" & VB6.Format(Me.dtpHasta.Value, C_FORMATFECHAGUARDAR) & "') and " & " a.nTipoMovto = 6 " & cWHERE & " order by a.CodSucursal, a.FechaIngreso, a.nTipoMovto "
...
Merr:
    ...
    Public Sub Imprime()
        Dim rptVentasIngresosPorReparaciones As New rptVentasIngresosPorReparaciones
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptVentasIngresosPorReparaciones.SetDataSource(frmReportes.rsReport)
        End If
        ...
        If (txtMensaje.Text <> Nothing) Then
            ...
            rptVentasIngresosPorReparaciones.DataDefinition.ParameterFields("Mensaje").ApplyCurrentValues(pvNum)
        Else
        ...
        If (dtpDesde.Value <> Nothing) Then
            ...
            rptVentasIngresosPorReparaciones.DataDefinition.ParameterFields("dDesde").ApplyCurrentValues(pvNum)
        End If

        If (dtpHasta.Value <> Nothing) Then
            pdvNum.Value = dtpHasta.Value : pvNum.Add(pdvNum)
            rptVentasIngresosPorReparaciones.DataDefinition.ParameterFields("dHasta").ApplyCurrentValues(pvNum)
        End If

        If (gstrNombCortoEmpresa <> Nothing) Then
            pdvNum.Value = gstrNombCortoEmpresa : pvNum.Add(pdvNum)
            rptVentasIngresosPorReparaciones.DataDefinition.ParameterFields("Empresa").ApplyCurrentValues(pvNum)
        End If
        ...
        If (Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Checked Or Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Unchecked) Then
            ...
            rptVentasIngresosPorReparaciones.DataDefinition.ParameterFields("DescontarComision").ApplyCurrentValues(pvNum)
        End If


        frmReportes.reporteActual = rptVentasIngresosPorReparaciones 'Es el nombre del archivo que se incluyó en el proyecto
        frmReportes.Show()
...
Merr:
    ...
    Private Sub frmVtasRPTIngresosPorReparaciones_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmVtasRPTIngresosPorReparaciones_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmVtasRPTIngresosPorReparaciones_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmVtasRPTIngresosPorReparaciones_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmVtasRPTIngresosPorReparaciones_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
    ...
    Private Sub frmVtasRPTIngresosPorReparaciones_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmVtasRPTIngresosPorReparaciones_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
