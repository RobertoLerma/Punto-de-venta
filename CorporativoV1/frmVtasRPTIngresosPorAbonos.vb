...
Public Class frmVtasRPTIngresosPorAbonos
    ...
    Public Sub InitializeComponent()
        ...
        Me.txtMensaje.Location = New System.Drawing.Point(9, 185)
        ...
        Me.txtMensaje.Size = New System.Drawing.Size(332, 76)
        ...
        Me.chkDescontar.Location = New System.Drawing.Point(12, 128)
        ...
        Me.chkDescontar.Size = New System.Drawing.Size(169, 17)
        ...
        Me.chkTodas.Size = New System.Drawing.Size(158, 20)
        ...
        Me._fraVtas_3.Location = New System.Drawing.Point(9, 58)
        ...
        Me._fraVtas_3.Size = New System.Drawing.Size(332, 53)
        ...
        Me.dtpDesde.Location = New System.Drawing.Point(59, 20)
        ...
        Me.dtpHasta.Location = New System.Drawing.Point(219, 20)
        ...
        Me._lblVentas_3.Location = New System.Drawing.Point(18, 23)
        ...
        Me._lblVentas_2.Location = New System.Drawing.Point(181, 23)
        ...
        'dbcSucursal
        '
        Me.dbcSucursal.Location = New System.Drawing.Point(68, 33)
        ...
        Me._lblVentas_0.Location = New System.Drawing.Point(16, 36)
        ...
        Me._lblRpt_2.Location = New System.Drawing.Point(10, 160)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(123, 277)
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(8, 277)
        ...
        'btnBuscar
        '
        Me.btnBuscar.Location = New System.Drawing.Point(238, 278)
        ...
        Me.Name = "frmVtasRPTIngresosPorAbonos"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds
        Me.Text = "Ingresos por Abonos a Documentos"
...
Merr:
    ...
    Public Sub Imprime()
        Dim rptVentasIngresosPorAbonosySucursal As New rptVentasIngresosPorAbonosySucursal
        ...
        If frmReportes.rsReport.RecordCount = 0 Then
            ...
            Exit Sub
        Else
            rptVentasIngresosPorAbonosySucursal.SetDataSource(frmReportes.rsReport)
        End If
        ...
        If (txtMensaje.Text <> Nothing) Then
            ...
            rptVentasIngresosPorAbonosySucursal.DataDefinition.ParameterFields("Mensaje").ApplyCurrentValues(pvNum)
        Else
        ...
        If (dtpDesde.Value <> Nothing) Then
            ...
            rptVentasIngresosPorAbonosySucursal.DataDefinition.ParameterFields("dDesde").ApplyCurrentValues(pvNum)
        End If

        If (dtpHasta.Value <> Nothing) Then
            pdvNum.Value = dtpHasta.Value : pvNum.Add(pdvNum)
            rptVentasIngresosPorAbonosySucursal.DataDefinition.ParameterFields("dHasta").ApplyCurrentValues(pvNum)
        End If

        If (gstrNombCortoEmpresa <> Nothing) Then
            pdvNum.Value = gstrNombCortoEmpresa : pvNum.Add(pdvNum)
            rptVentasIngresosPorAbonosySucursal.DataDefinition.ParameterFields("Empresa").ApplyCurrentValues(pvNum)
        End If
        ...
        If (Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Checked Or Me.chkDescontar.CheckState = System.Windows.Forms.CheckState.Unchecked) Then
            ...
            rptVentasIngresosPorAbonosySucursal.DataDefinition.ParameterFields("DescontarComision").ApplyCurrentValues(pvNum)
        End If

        frmReportes.reporteActual = rptVentasIngresosPorAbonosySucursal 'Es el nombre del archivo que se incluyó en el proyecto
        frmReportes.Show()
...
Merr:
    ...
    Private Sub frmVtasRPTIngresosPorAbonos_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
        Me.BringToFront()
    End Sub

    Private Sub frmVtasRPTIngresosPorAbonos_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
    End Sub

    Private Sub frmVtasRPTIngresosPorAbonos_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmVtasRPTIngresosPorAbonos_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmVtasRPTIngresosPorAbonos_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        InitializeComponent()
        ModEstandar.ActivaMenu(C_ACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_ACTIVADO, C_ACTIVADO)
    ...
    Private Sub frmVtasRPTIngresosPorAbonos_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmVtasRPTIngresosPorAbonos_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ModEstandar.ActivaMenu(C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO, C_DESACTIVADO)
