...
Public Class rptKardexArticulo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptKardexArticulo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TextoAdicional() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptKardexArticulo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKardexArticulo = New rptKardexArticulo()
        rpt.Site = Me.Site
        Return rpt
    End Function
