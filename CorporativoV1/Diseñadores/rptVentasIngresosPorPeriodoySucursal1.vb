...
Public Class rptVentasIngresosPorPeriodoySucursal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVentasIngresosPorPeriodoySucursal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptVentasIngresosPorPeriodoySucursal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DescontarComision() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptVentasIngresosPorPeriodoySucursal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasIngresosPorPeriodoySucursal = New rptVentasIngresosPorPeriodoySucursal()
        rpt.Site = Me.Site
        Return rpt
    End Function
