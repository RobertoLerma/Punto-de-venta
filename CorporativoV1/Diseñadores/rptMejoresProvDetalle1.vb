...
Public Class rptMejoresProvDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMejoresProvDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptMejoresProvDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMejoresProvDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMejoresProvDetalle = New rptMejoresProvDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
