...
Public Class RptCorpoRptClientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptCorpoRptClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.RptCorpoRptClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCorpoRptClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCorpoRptClientes = New RptCorpoRptClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
