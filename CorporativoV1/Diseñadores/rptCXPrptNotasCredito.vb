...
Public Class rptCXPrptNotasCredito
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCXPrptNotasCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptCXPrptNotasCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCXPrptNotasCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCXPrptNotasCredito = New rptCXPrptNotasCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
