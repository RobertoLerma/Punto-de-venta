...
Public Class rptRelaciondeGastos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRelaciondeGastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptRelaciondeGastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRelaciondeGastos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRelaciondeGastos = New rptRelaciondeGastos()
        rpt.Site = Me.Site
        Return rpt
    End Function
