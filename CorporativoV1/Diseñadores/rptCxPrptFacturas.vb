...
Public Class rptCxPrptFacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorporativoV1.rptCxPrptFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCxPrptFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCxPrptFacturas = New rptCxPrptFacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
